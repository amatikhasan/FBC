...
public class MessageRealmProxy extends com.verbosetech.yoohoo.models.Message
    ...
    public static MessageColumnInfo validateTable(SharedRealm sharedRealm, boolean allowExtraColumns) {
        ...
        Table table_9 = sharedRealm.getTable("class_Attachment");
        if (!table.getLinkTarget(columnInfo.attachmentIndex).hasSameSchema(table_9)) {
            throw new RealmMigrationNeededException(sharedRealm.getPath(), "Invalid RealmObject for field 'attachment': '" + table.getLinkTarget(columnInfo.attachmentIndex).getName() + "' expected - was '" + table_9.getName() + "'");
        }
